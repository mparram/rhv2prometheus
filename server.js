...
var RHVserver = process.env.RHVserver || "http://127.0.0.1:3001" ;//"https://rhvm-b5f6.rhpds.opentlc.com" example for opentlc labs, "http://127.0.0.1:3001" for localhost API simulator
// If RHVtest = true then RHV Server to simulator defaults
if (process.env.RHVtest == "true"){
  var RHVserver = "https://127.0.0.1:3001" ;
}
