        ...
        fs.readFile("nagios_templates/host_template.cfg", "utf8", (err2, host_template) => {
            ...
            fs.readFile("nagios_templates/service_template.cfg", "utf8", (err3, service_template) => {
                ...
                fs.readFile("nagios_templates/pre_template.cfg", "utf8", (err4, pre_template) => {
                    ...
                    db.readNagiosThresholds(function(thresholds) {
                        ...
                        if (err4) throw err;
                            ...
                            for(i=0;i<data.length;i++)
                            {
                                ...
                                for(var t in thresholds['rows'])
                                {
                                    
                                    if (splitValue[2].substring(0,thresholds['rows'][t]['doc'].name.length) == thresholds['rows'][t]['doc'].name)
                                    {

                                        thresholdsAttr = " -w " + thresholds['rows'][t]['doc'].warning + " -c " + thresholds['rows'][t]['doc'].critical + " -m " + thresholds['rows'][t]['doc'].comparemethod;
                                        var metricID = "'" + splitValue[2].replace(/'/g, "\"") + "'" + thresholdsAttr;
